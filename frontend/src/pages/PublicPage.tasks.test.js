...
describe('PublicPage 任务面板', () => {
    ...
    it('任务页展示任务列表和领取按钮', () => {
        ...
        expect(taskPageSource).toContain('visibleTaskGroups')
        expect(taskPageSource).toContain('activeTaskGroup')
        expect(taskPageSource).toContain('activeTasks')
        expect(taskPageSource).toContain('selectTaskGroup')
        expect(taskPageSource).toContain('task-card__tabs')
        expect(taskPageSource).toContain('task-card__tab')
        expect(taskPageSource).toContain('日常 / 周常')
        expect(taskPageSource).toContain('活动')
        expect(taskPageSource).toContain('长期有效')
