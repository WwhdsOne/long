    ...
    <section v-else class="admin-layout">
      <article class="admin-card admin-card--toolbar">
        ...
        <div class="admin-toolbar__actions">
          <label class="admin-room-select">
            <span>房间</span>
            <select class="nickname-form__input" :value="admin.adminRoomId"
                    @change="admin.switchAdminRoom($event.target.value)">
      ...
      <article class="admin-card">
        <div class="admin-tabs">
          <button class="admin-tab" :class="{ 'admin-tab--active': admin.activeTab === 'boss' }"
                  @click="admin.activeTab = 'boss'">Boss
          </button>
          <button class="admin-tab" :class="{ 'admin-tab--active': admin.activeTab === 'equipment' }"
                  @click="admin.activeTab = 'equipment'; admin.fetchEquipmentPage(admin.equipmentPage.page)">装备
          </button>
          <button class="admin-tab" :class="{ 'admin-tab--active': admin.activeTab === 'shop' }"
                  @click="admin.activeTab = 'shop'; admin.fetchShopItems()">商店
          </button>
          <button class="admin-tab" :class="{ 'admin-tab--active': admin.activeTab === 'rooms' }"
                  @click="admin.activeTab = 'rooms'; admin.fetchAdminRoomSettings()">房间
          </button>
          <button class="admin-tab" :class="{ 'admin-tab--active': admin.activeTab === 'content' }"
                  @click="admin.activeTab = 'content'; admin.fetchAnnouncements(); admin.fetchMessages()">内容
          </button>
          <button class="admin-tab" :class="{ 'admin-tab--active': admin.activeTab === 'history' }"
                  @click="admin.activeTab = 'history'; admin.fetchBossHistory(admin.bossHistoryPage.page)">历史
          </button>
          <button class="admin-tab" :class="{ 'admin-tab--active': admin.activeTab === 'tasks' }"
