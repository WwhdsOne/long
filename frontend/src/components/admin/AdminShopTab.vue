    ...
    <article class="admin-panel">
      ...
      <form class="admin-form" @submit.prevent="saveShopItem">
        <div class="nickname-form__group">
          ...
          <input v-model="shopItemForm.itemId" class="nickname-form__input" type="text" placeholder="itemId"
                 id="itemId"/>
        </div>
        <div class="nickname-form__group">
        ...
        <div class="nickname-form__group">
          ...
          <input v-model="shopItemForm.priceGold" class="nickname-form__input" type="number" min="0"
                 placeholder="金币价格" id="priceGold"/>
        </div>
        <div class="nickname-form__group">
          <label for="sortOrder">排序:</label>
          <input v-model="shopItemForm.sortOrder" class="nickname-form__input" type="number" placeholder="排序"
                 id="sortOrder"/>
        </div>
        <div class="nickname-form__group">
          <label for="imagePath">主图 URL:</label>
          <input v-model="shopItemForm.imagePath" class="nickname-form__input" type="text" placeholder="主图 URL"
                 id="imagePath"/>
        </div>
        <div class="nickname-form__group">
          <label for="previewImagePath">预览图 URL:</label>
          <input v-model="shopItemForm.previewImagePath" class="nickname-form__input" type="text"
                 placeholder="预览图 URL" id="previewImagePath"/>
        </div>
        <div class="nickname-form__group">
          <label for="battleClickCursorImagePath">战斗光标 URL:</label>
          <input v-model="shopItemForm.battleClickCursorImagePath" class="nickname-form__input" type="text"
                 placeholder="战斗光标 URL" id="battleClickCursorImagePath"/>
        </div>
        <div class="nickname-form__group">
          <label for="imageAlt">图片 alt:</label>
          <input v-model="shopItemForm.imageAlt" class="nickname-form__input" type="text" placeholder="图片 alt"
                 id="imageAlt"/>
        </div>
        <div class="nickname-form__group">
          <label for="description">描述:</label>
          <textarea v-model="shopItemForm.description" class="nickname-form__input" rows="4" placeholder="描述"
