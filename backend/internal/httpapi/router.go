...
type ButtonStore interface {
	...
	BulkSalvageUnequipped(context.Context, string) (vote.BulkSalvageResult, error)
	LockItem(context.Context, string, string) (vote.State, error)
	UnlockItem(context.Context, string, string) (vote.State, error)
